...
Do not conflate this with DFlash. The public oMLX v0.6.1 dependency is `jundot/dflash-mlx@2eb169f4`, whose pinned target/draft registry does not include Qwen3.8. The entry's DFlash2 note refers to a closed/private dependency and is not a publicly reproducible candidate. Native MTP and DFlash are mutually exclusive in oMLX.
