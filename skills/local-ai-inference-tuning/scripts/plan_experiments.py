        ...
        return [
            ...
            },
            {
                ...
                **artifact_contract("community-target-plus-draft"),
                ...
                "sweeps": {"method": ["AR", "external-DSpark"], "draft_cap": "machine/model/quant/domain cost-curve auto-cap", "fallbacks": ["lookup", "DFlash-only-if-public-exact-pair"]},
                "caveat": "Re-run token-by-token race/equality, domain-separated acceptance, and quality gates. Public DFlash in the pinned oMLX dependency does not register a Qwen3.8 pair, and the claimed DFlash2 path is not publicly reproducible.",
            },
            {
